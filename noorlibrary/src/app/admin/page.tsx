...
export default function AdminDashboard() {
  ...
  const [newBook, setNewBook] = useState<Partial<Book>>({
    title: '', author: 'Author Al-Noor', description: '', coverUrl: '', pdfPath: '', jsonPath: '', contentType: 'pdf', isSecure: true
  });
  ...
  const openAddModal = () => {
    ...
    setNewBook({ title: '', author: 'Author Al-Noor', description: '', coverUrl: '', pdfPath: '', jsonPath: '', contentType: 'pdf', isSecure: true });
  ...
  const openEditModal = (book: Book) => {
    ...
    setNewBook({
      title: book.title, author: book.author, description: book.description, coverUrl: book.coverUrl, pdfPath: book.pdfPath, jsonPath: book.jsonPath || '', contentType: book.contentType || 'pdf', isSecure: book.isSecure !== false
    });
